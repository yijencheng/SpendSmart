...
4. [Custom Views & Components](#custom-views--components)
...
For detailed information about SwiftUI property wrappers, see:

👉 **[Property Wrappers Guide](view/property_wrappers.md)** - Complete guide to `@State`, `@Binding`, `@EnvironmentObject`, `@StateObject`, `@Published`, and when to use each
